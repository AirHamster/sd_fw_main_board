...
-DUSE_XBEE_MODULE=${USE_XBEE_MODULE}\
-DUSE_SERVICE_MODE=${USE_SERVICE_MODE}\
-DUSE_FSM_MODULE=${USE_FSM_MODULE}\
-DUSE_EEPROM_MODULE=${USE_EEPROM_MODULE}\
-DUSE_LAG_MODULE=${USE_LAG_MODULE}\
-DUSE_ADC_MODULE=${USE_ADC_MODULE}\
-DUSE_TENSO_MODULE=${USE_TENSO_MODULE}\
-DUSE_JSON_MODULE=${USE_JSON_MODULE}\
-DUSE_FUSION_MODULE=${USE_FUSION_MODULE}\
-DUSE_MATH_MODULE=${USE_MATH_MODULE}\
-DUSE_MCU_MCU_MODULE=${USE_MCU_MCU_MODULE}\
